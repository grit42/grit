...
### Added
- (core,assays,compounds) permission-based roles, enabling custom roles with granular permissions to reflect organisations roles

### Fixed
- update dependencies to the latest stable versions
- authorisation bypass in export endpoints
