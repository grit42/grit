...
const SvgCircle1New = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <style>
      {
        ".circle-1new_svg__st0{display:none}.circle-1new_svg__st1{display:inline}"
      }
    </style>
    <g id="circle-1new_svg__circle-border">
      <g id="circle-1new_svg__Icon-Plus_3_" transform="translate(28 278)">
        <path
          id="circle-1new_svg__Fill-38_3_"
    ...
    <path
      d="M12 7.6H8.4V4h-.8v3.6H4v.8h3.6V12h.8V8.4H12z"
      id="circle-1new_svg__circle-new"
    />
  </svg>
);

const Memo = memo(SvgCircle1New);
export default Memo;
