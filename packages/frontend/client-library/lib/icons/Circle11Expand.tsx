...
const SvgCircle11Expand = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <style>
      {
        ".circle-11expand_svg__st0{display:none}.circle-11expand_svg__st1{display:inline}"
      }
    </style>
    <g id="circle-11expand_svg__circle-border">
      <g id="circle-11expand_svg__Icon-Plus_3_" transform="translate(28 278)">
        <path
          id="circle-11expand_svg__Fill-38_3_"
    ...
    <g id="circle-11expand_svg__circle-expand">
      <path d="M5.7 10.3V6.8h-.9v4.4h4.4v-.9zM6.8 4.8v.9h3.5v3.5h.9V4.8z" />
    </g>
  </svg>
);

const Memo = memo(SvgCircle11Expand);
export default Memo;
