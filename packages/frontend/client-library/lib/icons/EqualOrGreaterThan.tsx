...
const SvgEqualOrGreaterThan = (props: SVGProps<SVGSVGElement>) => (
  <svg
    viewBox="0 0 16 16"
  ...
  >
    <path
      d="M14.58 0C15.36 0 16 .64 16 1.42v13.16c0 .78-.64 1.42-1.42 1.42H1.42C.64 16 0 15.36 0 14.58V1.42C0 .64.64 0 1.42 0Zm-.01.94H1.41a.48.48 0 0 0-.48.48v13.16c0 .27.22.48.48.48h13.16c.27 0 .48-.22.48-.48V1.42a.48.48 0 0 0-.48-.48Zm-3.645 9.86a.5.5 0 0 1 .09.992l-.09.008h-5.95a.5.5 0 0 1-.09-.992l.09-.008h5.95Zm.246-4.438a.496.496 0 0 1 .233.597.506.506 0 0 1-.03.07l-.006.012a.496.496 0 0 1-.205.201l-.04.02L5.14 9.754a.5.5 0 0 1-.464-.882l.08-.042 4.75-1.979-4.717-1.577-.082-.036a.5.5 0 0 1 .4-.912l5.981 2 .044.017.027.013Z"
      fillRule="nonzero"
    />
  </svg>
);

const Memo = memo(SvgEqualOrGreaterThan);
export default Memo;
