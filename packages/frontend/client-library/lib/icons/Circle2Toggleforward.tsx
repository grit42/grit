...
const SvgCircle2Toggleforward = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <style>
      {
        ".circle-2toggleforward_svg__st0{display:none}.circle-2toggleforward_svg__st1{display:inline}"
      }
    </style>
    <g id="circle-2toggleforward_svg__circle-border">
      <g
        id="circle-2toggleforward_svg__Icon-Plus_3_"
        transform="translate(28 278)"
      >
        <path
          id="circle-2toggleforward_svg__Fill-38_3_"
    ...
    <path
      d="M10.9 8 7.8 4.9l-.7.6L9.6 8l-2.5 2.5.7.6 2.5-2.5h-.1z"
      id="circle-2toggleforward_svg__circle-toggleforward"
    />
  </svg>
);

const Memo = memo(SvgCircle2Toggleforward);
export default Memo;
