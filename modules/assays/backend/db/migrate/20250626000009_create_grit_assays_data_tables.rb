class CreateGritAssaysDataTables < ActiveRecord::Migration[7.2]
  def up
    create_table :grit_assays_data_tables, id: false do |t|
  ...
  def down
    drop_table :grit_assays_data_tables

    execute "DROP TRIGGER IF EXISTS manage_stamps_grit_assays_data_tables ON public.grit_assays_data_tables;"
  end
end
