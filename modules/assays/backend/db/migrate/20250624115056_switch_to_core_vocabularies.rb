class SwitchToCoreVocabularies < ActiveRecord::Migration[7.2]
  def up
    ...
    add_foreign_key :grit_assays_assay_metadata_definitions, :grit_core_vocabularies, column: :vocabulary_id
    ...
    add_foreign_key :grit_assays_assay_metadata, :grit_core_vocabularies, column: :vocabulary_id
    add_foreign_key :grit_assays_assay_metadata, :grit_core_vocabulary_items, column: :vocabulary_item_id
