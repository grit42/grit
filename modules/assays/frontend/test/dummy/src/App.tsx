...
const LazyAssaysRouter = lazy(() =>
  import("@grit/assays").then((module) => ({ default: module.Router })),
);
import { Meta as AssaysMeta } from "@grit/assays";
...
const NAV_ITEMS = [...AssaysMeta.navItems, ...CoreMeta.navItems.filter(({name}) => name !== "Entities")];
