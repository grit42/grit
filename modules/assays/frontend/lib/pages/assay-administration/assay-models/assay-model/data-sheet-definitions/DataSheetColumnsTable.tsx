...
const DataSheetDefinitionColumnsTable = ({
  dataSheetDefinitionId,
  disableNavigation = false,
}: {
  dataSheetDefinitionId: string | number;
  ...
  const { data, isLoading } = useAssayDataSheetColumns(
    ...
    undefined,
    {
      enabled: dataSheetDefinitionId !== "new",
    },
  );

  const canCreateColumn =
    dataSheetDefinitionId !== "new" && canEdit && data && data.length < 250;
...
export default DataSheetDefinitionColumnsTable;
