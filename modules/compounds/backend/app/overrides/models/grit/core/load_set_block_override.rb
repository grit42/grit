...
Grit::Core::LoadSetBlock.class_eval do
  has_one :compound_load_set_block, dependent: :destroy, class_name: "Grit::Compounds::CompoundLoadSetBlock"
  has_one :batch_load_set_block, dependent: :destroy, class_name: "Grit::Compounds::BatchLoadSetBlock"
end
