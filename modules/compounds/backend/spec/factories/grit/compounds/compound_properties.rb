...
FactoryBot.define do
  factory :grit_compounds_compound_property, class: "Grit::Compounds::CompoundProperty" do
    sequence(:name) { |n| "CompoundProp #{n}" }
    sequence(:safe_name) { |n| "cprop_#{n}" }
    description { "A compound property" }
    required { false }
