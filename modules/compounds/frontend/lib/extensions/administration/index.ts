...
import CompoundAdministrationTab from "./tabs/compounds";
import { useRegisterAdministrationTabs } from "@grit/core";

const useRegisterCompoundAdministration = () => {
...
export default useRegisterCompoundAdministration;
