...
--
-- Name: grit_core_vocabulary_10310_vocabulary_items; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.grit_core_vocabulary_10310_vocabulary_items AS
 SELECT id,
    created_by,
    created_at,
    updated_by,
  ...
  WHERE (vocabulary_id = 10310);


--
-- Name: grit_core_vocabulary_10313_vocabulary_items; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.grit_core_vocabulary_10313_vocabulary_items AS
 SELECT id,
    created_by,
    created_at,
    updated_by,
