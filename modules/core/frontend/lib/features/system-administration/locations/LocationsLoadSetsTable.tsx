...
const LocationLoadSetsTable = () => {
  ...
  return (
    <Table<EntityData>
      ...
      noDataMessage={"No load sets for Locations"}
      pagination={{
        fetchNextPage,
        isFetchingNextPage,
...
export default LocationLoadSetsTable;
